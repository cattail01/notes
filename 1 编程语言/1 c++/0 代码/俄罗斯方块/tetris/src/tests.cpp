...
#include "../headers/define_blocks.hpp"
#include "../headers/base_func.hpp"
#include "../headers/basic_element_controller.hpp"
...
int main(){
	Basic_element_controller bec;
	bec.show_procest_blocks();
}
